...
export function ChatPage() {
  ...
  const canUseAi =
    MOCK_MODE || MOCK_API || Boolean(editor.apiConfig.apiToken.trim());
  ...
  return (
    <>
      <section className="flex h-full min-h-0 flex-1 flex-col overflow-hidden bg-base-200">
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden ">
          <div className="hidden h-full min-h-0 overflow-hidden gap-3 lg:flex">
            <SidePanel
              side="left"
              open={showEditor}
          ...
          <div className="flex flex-col min-h-0 min-w-0 flex-1 overflow-hidden lg:hidden">
            <ChatPanel
              canUseAi={canUseAi}
              guidedCreationToken={guidedCreationToken}
              onStartGuidedCreation={handleStartGuidedCreation}
