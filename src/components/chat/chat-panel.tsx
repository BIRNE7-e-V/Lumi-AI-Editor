...
export const ChatPanel = memo(function ChatPanel({
  ...
  return (
    <section
      ref={rootRef}
      className="flex min-h-full flex-1 flex-col overflow-hidden rounded-box border border-base-300 bg-base-100 shadow-sm"
    >
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden px-5 py-5">
        <div className="flex min-h-0 flex-1 flex-col gap-3 overflow-y-auto rounded-box bg-base-200/80 p-4">
            ...
            chat.messages.map((message) => {
              ...
              return (
                ...
                >
                  <div
                    className={twMerge(
                      'max-w-[85%] min-w-[30%] rounded-box px-4 py-3 text-sm leading-6 shadow-sm',
                      isAssistant
                  ...
                  >
                    ...
                    {isAssistant && speech.ttsSupported ? (
                      <div className="mt-3 flex justify-start">
                        <button
                          className="btn btn-secondary btn-outline btn-xs cursor-pointer flex gap-1 items-center"
                          type="button"
                          onClick={() => {
                            if (isSpeaking) {
                              speech.stopSpeaking();
                      ...
                      <div className="mt-3 flex flex-wrap gap-2">
                        {suggestions.map((suggestion) => (
                          <button
                            ...
                            className="badge cursor-pointer border-primary text-primary hover:bg-primary hover:text-primary-content"
        ...
        <div className="rounded-box border border-base-300 bg-base-100 p-3 shadow-sm">
          {speech.isListening || speech.isTranscribing ? (
            <div className="mb-3 rounded-box border border-error/20 bg-error/5 px-3 py-3">
          ...
          {!canUseAi ? (
            <div className="mb-3 rounded-box border border-warning/30 bg-warning/10 px-3 py-2 text-sm text-warning-content">
