...
export const AiContentModal = memo(function AiContentModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-base-content/40 p-4">
      <div className="w-full max-w-2xl rounded-box border border-base-300 bg-base-100 shadow-2xl">
