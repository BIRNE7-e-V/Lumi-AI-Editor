...
import { AiContentModal, INITIAL_AI_DIALOG, type AiDialogState } from '@components/editor/ai-content-modal';
...
const EmptyState = memo(function EmptyState({
  ...
  return (
    <div className="rounded-box border border-dashed border-base-300 bg-base-200/80 px-6 py-10 text-center">
...
export const EditorSidebar = memo(function EditorSidebar({
  ...
  return (
    <aside className="flex h-full min-h-0 flex-col overflow-hidden bg-base-100 shadow-sm">
      <header className="border-b border-base-300 px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-base-content/60">Titel, Inhalte und Struktur des Blatts.</p>
          </div>
        </div>
      </header>
      ...
      <div className="shrink-0 border-t border-base-300 px-5 py-4 flex flex-col gap-3">
        {feedback ? (
          <div
            className={twMerge(
